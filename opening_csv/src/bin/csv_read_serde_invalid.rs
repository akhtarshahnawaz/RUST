...
// csv crate provides a helper function that can be applied to Option fields that tells Serde to convert the value to None 
//if an error occurs. 
...
/// Reads data from a file into a reader and deserializes each records
